![alt text](https://github.com/Carrion-lab/microLife/images/workflow.png?raw=true)


# Download MicroLife

```
 git clone --branch MicroLife2.2  https://gitlab.services.universiteitleiden.nl/guerreroegidog/microlife.git <your comparative project name>
```
...
![alt text](https://github.com/Carrion-lab/microLife/images/screenshot.png?raw=true)

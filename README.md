![alt text](https://github.com/Carrion-lab/microLife/image/workflow.png?raw=true)
...
![alt text](https://github.com/Carrion-lab/microLife/image/screenshot.png?raw=true)
